...
* **Полноценный MPRIS v2:**
  ...
  * Локальное кэширование обложек в высоком разрешении (`~/.cache/youmz/covers/`, `file://` URI) для мгновенного отображения в шторках окружений (Dank Linux / QuickShell), виджетах и на экранах блокировки.
